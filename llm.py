...
def display_images(directory, image_list):
    ...
    # Create subplots
    fig, axes = plt.subplots(1, num_images, figsize=(15, 5), gridspec_kw={'width_ratios': [3] + [1]*(num_images-1)})
...
def match_images_with_description(analysis_results, user_description, k=5):
    matching_results = []
    ...
    # Sort results by confidence score in descending order and return top k results
